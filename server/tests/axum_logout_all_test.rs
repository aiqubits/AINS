...
use ains_axum::middleware::auth_middleware;
...
/// Refresh cookie name.
const REFRESH_COOKIE: &str = "ains_refresh";
...
async fn create_test_app() -> Router {
    ...
    Router::new()
        ...
        .layer(from_fn(ains_axum::middleware::panic_middleware))
