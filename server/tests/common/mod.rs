...
pub fn load_test_config() -> ains_server::utils::AppConfig {
...
pub async fn create_test_db_and_run_migrations() -> Arc<ains_server::AutoRouter> {
...
pub async fn create_cache_service() -> ains_server::services::CacheService {
    let config = load_test_config();
