...
fn default_database_url() -> String {
    "postgres://postgres:CHANGE_ME_POSTGRES_PASSWORD@127.0.0.1:5432/ains".to_string()
}
...
mod tests {
    ...
    fn test_app_config_clone() {
        let config = AppConfig {
            ...
            cookie_secure: true,
            system_admin_email: "admin@ains.local".to_string(),
    ...
    /// Verify that `AINS_SERVER__ALLOWED_ORIGINS` is correctly parsed
    ...
    fn test_allowed_origins_from_env_list() {
        ...
        source.insert(
            "AINS_SERVER__ALLOWED_ORIGINS".to_string(),
