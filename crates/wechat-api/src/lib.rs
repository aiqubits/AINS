//! # wechat-api
//!
//! Extensible WeChat Official Account SDK for **ains**.
//!
...
//! ┌─────────────────────────────────────────────────────┐
//! │                  Host Application                    │
//! │  (ains-server / any axum/salvo app)              │
//! │                                                      │
//! │  ┌──────────────┐   implements   ┌────────────────┐  │
...
//!
//!    #[async_trait]
//!    impl CaptchaStore for ains_server::services::CacheService { /* ... */ }
//!    ```
//!
