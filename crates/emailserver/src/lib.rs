...
<p>Hello!</p>
<p>You are registering for AINS.</p>
...
<p style="color: #718096; font-size: 12px;">AINS Team</p>
</div>
</body>
</html>"#,
            code, expires_minutes
...
<p style="color: #718096; font-size: 12px;">AINS Team</p>
    ...
    pub async fn send_welcome_email(&self, to: &str, name: Option<&str>) -> Result<(), EmailError> {
        ...
        let subject = "Welcome to AINS";
        let text_body = format!(
            "{text_greeting}\n\nCongratulations on verifying your email address.\n\nYou can now start using all features of AINS.\n\nIf you have any questions, please contact our support team.\n\nBest regards,\nAINS Team\n"
        );
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
<h2 style="color: #2c5282;">Welcome to AINS</h2>
<p>{}</p>
<p>Congratulations on verifying your email address.</p>
<p>You can now start using all features of AINS.</p>
